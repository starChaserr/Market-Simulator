...
def trade_loop(args: argparse.Namespace) -> int:
    ...
    while True:
        ...
        if (price_moved or inventory_changed) and (now - last_quote_at >= throttle_gap):
            ...
            # Risk Overlay: stop quoting on the side that increases risk if adverse selection is high
            ...
            if adverse > 0.8:
                ...
                logging.warning("RISK OVERLAY: Halting inventory-increasing quotes due to high adverse selection")
